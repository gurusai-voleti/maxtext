...
class Engram(BaseModel):
  ...
  engram_head_dim: int = Field(1280, description="Head dimension for a single head.")
  engram_vocab_sizes: list[int] = Field(
      default_factory=list, description="List of vocab sizes for each n-gram order."
  )
